...
; 0000 00BD // USART Mode: Sync. Slave UCPOL=1
; 0000 00BE UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00BF UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 00C0 UCSRC=(1<<URSEL) | (1<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (1<<UCPOL);
	LDI  R30,LOW(199)
	OUT  0x20,R30
...
; 0000 00D9 
; 0000 00DA         // first received data is the address
; 0000 00DB         address = getchar();
	RCALL _getchar
	MOV  R16,R30
; 0000 00DC         if(address == 0x02){
	CPI  R16,2
	BRNE _0x17
; 0000 00DD             //if address matches then data is useful
; 0000 00DE             data = getchar();
	RCALL _getchar
	MOV  R17,R30
; 0000 00DF             lcd_putchar(data);
	MOV  R26,R17
	RCALL _lcd_putchar
; 0000 00E0 
; 0000 00E1             // send delivery message to master
; 0000 00E2             putchar(0xF2);
	LDI  R26,LOW(242)
	RCALL _putchar
; 0000 00E3 
; 0000 00E4         }
