...
_0x0:
	.DB  0x44,0x65,0x6C,0x69,0x76,0x65,0x72,0x65
	.DB  0x64,0x20,0x2E,0x2E,0x2E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00AB // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 00AC DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(1)
	OUT  0x17,R30
; 0000 00AD // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 00C0 // USART Mode: Sync. Master UCPOL=0
; 0000 00C1 // USART Baud Rate: 4800
; 0000 00C2 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00C3 UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 00C4 UCSRC=(1<<URSEL) | (1<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(198)
	OUT  0x20,R30
; 0000 00C5 UBRRH=0x03;
	LDI  R30,LOW(3)
	OUT  0x20,R30
; 0000 00C6 UBRRL=0x40;
	LDI  R30,LOW(64)
	OUT  0x9,R30
; 0000 00C7 
...
; 0000 00D3 lcd_init(16);
	...
	RCALL _lcd_init
; 0000 00D4 
; 0000 00D5 // address of slave 1
; 0000 00D6 //putchar(0x01);
; 0000 00D7 
; 0000 00D8 // data for slave 1
; 0000 00D9 //putchar('a');
; 0000 00DA 
; 0000 00DB 
; 0000 00DC // address of slave 2
; 0000 00DD putchar(0x02);
	LDI  R26,LOW(2)
	RCALL _putchar
; 0000 00DE 
; 0000 00DF 
; 0000 00E0 // data for slave 2
; 0000 00E1 putchar('b');
	LDI  R26,LOW(98)
	RCALL _putchar
; 0000 00E2 
; 0000 00E3 
; 0000 00E4 // get delivery Report from slave number 2
; 0000 00E5 data1 = getchar();
	RCALL _getchar
	MOV  R17,R30
; 0000 00E6 if(data1 == 0xF1) lcd_puts("Delivered ...");
	CPI  R17,241
	BRNE _0x14
	__POINTW2MN _0x15,0
	RCALL _lcd_puts
; 0000 00E7 
; 0000 00E8 
; 0000 00E9 // Global enable interrupts
; 0000 00EA #asm("sei")
_0x14:
	sei
; 0000 00EB 
