...
; 0000 0036 
; 0000 0037 //  each time this ISR is called , meaning that a Compare Match occures , a = a + 1
; 0000 0038 a+= 1;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
; 0000 0047 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0048 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 0049 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 005C // OC0 output: Toggle on compare match
; 0000 005D // Timer Period: 0.776 ms
; 0000 005E // Output Pulse(s):
; 0000 005F // OC0 Period: 1.552 ms Width: 0.776 ms
; 0000 0060 TCCR0=(0<<WGM00) | (0<<COM01) | (1<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(27)
	OUT  0x33,R30
...
; 0000 0065 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 0066 
; 0000 0067 // External Interrupt(s) initialization
; 0000 0068 // INT0: On
; 0000 0069 // INT0 Mode: Any change
; 0000 006A // INT1: On
; 0000 006B // INT1 Mode: Rising Edge
; 0000 006C // INT2: Off
; 0000 006D GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 006E MCUCR=(1<<ISC11) | (1<<ISC10) | (0<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(13)
	OUT  0x35,R30
; 0000 006F MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0070 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0071 
