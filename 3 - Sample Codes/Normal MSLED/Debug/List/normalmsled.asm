...
; 0000 003A DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
...
; 0000 0052 // Clock value: 1000.000 kHz
; 0000 0053 // Mode: Normal top=0xFF
; 0000 0054 // OC0 output: Disconnected
; 0000 0055 // Timer Period: 0.25 ms
; 0000 0056 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(2)
	OUT  0x33,R30
; 0000 0057 TCNT0=0x06;
	LDI  R30,LOW(6)
	OUT  0x32,R30
; 0000 0058 OCR0=0x00;
	LDI  R30,LOW(0)
