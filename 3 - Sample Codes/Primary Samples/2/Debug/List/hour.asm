...
; 0000 004D      }
_0x5:
; 0000 004E      sprintf(str,"%02d:%02d:%02d",Hour,Min,Sec);
_0x4:
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
...
; 0000 005D // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 005E DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 005F // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 0076 // Clock value: 0.977 kHz
; 0000 0077 // Mode: CTC top=OCR0
; 0000 0078 // OC0 output: Disconnected
; 0000 0079 // Timer Period: 99.328 ms
; 0000 007A TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(13)
	OUT  0x33,R30
...
; 0000 007F TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(3)
	OUT  0x39,R30
; 0000 0080 
; 0000 0081 // External Interrupt(s) initialization
; 0000 0082 // INT0: On
; 0000 0083 // INT0 Mode: Any change
; 0000 0084 // INT1: On
...
; 0000 0087 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	...
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0088 MCUCR=(1<<ISC11) | (1<<ISC10) | (0<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(13)
	OUT  0x35,R30
