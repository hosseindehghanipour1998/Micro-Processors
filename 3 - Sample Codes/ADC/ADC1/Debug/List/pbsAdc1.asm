...
_0x0:
	.DB  0x6B,0x61,0x6D,0x74,0x61,0x72,0x20,0x61
	.DB  0x7A,0x20,0x32,0x56,0x0,0x62,0x69,0x73
	.DB  0x68,0x74,0x61,0x72,0x20,0x61,0x7A,0x20
	.DB  0x32,0x56,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0038 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0039 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 003A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 0050 // ADC Clock frequency: 500.000 kHz
; 0000 0051 // ADC Voltage Reference: AREF pin
; 0000 0052 // ADC Auto Trigger Source: ADC Stopped
; 0000 0053 ADMUX=ADC_VREF_TYPE;
	OUT  0x7,R30
; 0000 0054 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	OUT  0x6,R30
...
; 0000 006C       lcd_puts("kamtar az 2V");
	__POINTW2MN _0xA,0
	RCALL SUBOPT_0x1
; 0000 006D       delay_ms(300);
; 0000 006E       }
; 0000 006F     if(a>410)
_0x9:
	LDI  R30,LOW(410)
...
; 0000 0073       lcd_puts("bishtar az 2V");
	__POINTW2MN _0xA,13
	RCALL SUBOPT_0x1
; 0000 0074       delay_ms(300);
; 0000 0075       }
; 0000 0076 
; 0000 0077 
; 0000 0078 
