...
; 0000 003C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 003D DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 003E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 0054 // ADC Clock frequency: 500.000 kHz
; 0000 0055 // ADC Voltage Reference: AREF pin
; 0000 0056 // ADC Auto Trigger Source: ADC Stopped
; 0000 0057 ADMUX=ADC_VREF_TYPE;
	OUT  0x7,R30
; 0000 0058 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	OUT  0x6,R30
...
; 0000 006C       a=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 006D       temp=a/2.054;
	CALL __CWD1
	CALL __CDF1
	MOVW R26,R30
	MOVW R24,R22
...
; 0000 0070       lcd_puts(str);
	...
	LDI  R27,HIGH(_str)
	CALL _lcd_puts
; 0000 0071       lcd_gotoxy(7,0);
	LDI  R30,LOW(7)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 0072       lcd_puts("C");
	__POINTW2MN _0x9,0
	CALL _lcd_puts
