...
_0x0:
	...
	.DB  0x0,0x74,0x31,0x3A,0x25,0x64,0x2C,0x74
	.DB  0x32,0x3A,0x25,0x64,0x0,0x6D,0x31,0x3A
	.DB  0x25,0x64,0x2C,0x6D,0x32,0x3A,0x25,0x64
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0038 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0039 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(7)
	OUT  0x17,R30
; 0000 003A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
...
; 0000 005F // Characters/line: 8
; 0000 0060 lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 0061 
; 0000 0062 while (1)
...
; 0000 006D         printf("%d\n",slave3);
	...
	MOV  R30,R11
	CALL SUBOPT_0x1
; 0000 006E         scanf("%d",&temp2);
	__GETD1N 0x6
	CALL SUBOPT_0x2
; 0000 006F         lcd_puts("1");
	__POINTW2MN _0x12,0
	RCALL _lcd_puts
; 0000 0070         if(temp2 < 25){
	LDI  R30,LOW(25)
	LDI  R31,HIGH(25)
	CP   R6,R30
	CPC  R7,R31
...
; 0000 0071             m1 = 10;
	...
	CALL SUBOPT_0x4
; 0000 0072         }
; 0000 0073         else if(temp2 >= 25 && temp2 <= 30){
	RJMP _0x14
_0x13:
	LDI  R30,LOW(25)
	LDI  R31,HIGH(25)
...
; 0000 0074             m1 = 50;
	...
	CALL SUBOPT_0x4
; 0000 0075         }
; 0000 0076         else if(temp2 >= 31 && temp2 <= 35){
	RJMP _0x18
_0x15:
	LDI  R30,LOW(31)
	LDI  R31,HIGH(31)
...
; 0000 0084         printf("%d\n",slave2);
	MOV  R30,R8
	CALL SUBOPT_0x1
; 0000 0085         scanf("%d",&status);
	__GETD1N 0xC
	CALL SUBOPT_0x2
; 0000 0086         if(status == 1){
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R12
	CPC  R31,R13
	BRNE _0x25
; 0000 0087             if((temp2 - temp1) == 0){
	MOVW R30,R6
	SUB  R30,R4
	SBC  R31,R5
	BRNE _0x26
; 0000 0088                 m2 = 0;
	...
	STS  _m2+1,R30
; 0000 0089             }
; 0000 008A             else if((temp2 - temp1) == 5){
	RJMP _0x27
_0x26:
	MOVW R26,R6
	SUB  R26,R4
...
; 0000 008B                 m2 = 50;
	...
	RJMP _0x2F
; 0000 008C             }
; 0000 008D             else if((temp2 - temp1) == 10){
_0x28:
	MOVW R26,R6
	SUB  R26,R4
	SBC  R27,R5
...
; 0000 008E                 m2 = 150;
	...
	RJMP _0x2F
; 0000 008F             }
; 0000 0090             else if((temp2 - temp1) == 15){
_0x2A:
	MOVW R26,R6
	SUB  R26,R4
	SBC  R27,R5
...
; 0000 0097         printf("%d\n",m2);
	...
	LDS  R31,_m2+1
	CALL SUBOPT_0x5
; 0000 0098         sprintf(str, "t1:%d,t2:%d", temp1, temp2);
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 009C         sprintf(str,"m1:%d,m2:%d", t, m2);
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
