...
; 0000 00AD // Wait for the AD conversion to complete
; 0000 00AE while ((ADCSRA & (1<<ADIF))==0);
; 0000 00AF ADCSRA|=(1<<ADIF);
; 0000 00B0 return ADCW;
; 0000 00B1 }
;
;void main(void)
; 0000 00B4 {
...
; 0000 00C6 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 00C7 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 00C8 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 00C9 
...
; 0000 00D1 // Clock source: T0 pin Rising Edge
; 0000 00D2 // Mode: Normal top=0xFF
; 0000 00D3 // OC0 output: Disconnected
; 0000 00D4 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(7)
	OUT  0x33,R30
...
; 0000 00DA // Clock value: Timer1 Stopped
; 0000 00DB // Mode: Normal top=0xFFFF
; 0000 00DC // OC1A output: Disconnected
; 0000 00DD // OC1B output: Disconnected
...
; 0000 00E4 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 00E5 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	OUT  0x2E,R30
...
; 0000 00F1 // Clock value: Timer2 Stopped
; 0000 00F2 // Mode: Normal top=0xFF
; 0000 00F3 // OC2 output: Disconnected
; 0000 00F4 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 00F5 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00FA TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 00FB 
...
; 0000 00FE // INT1: Off
; 0000 00FF // INT2: Off
; 0000 0100 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(0)
	OUT  0x35,R30
; 0000 0101 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0102 
...
; 0000 0108 // USART Baud Rate: 9600 (Double Speed Mode)
; 0000 0109 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (1<<U2X) | (0<<MPCM);
	LDI  R30,LOW(2)
	OUT  0xB,R30
; 0000 010A UCSRB=(1<<RXCIE) | (1<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(216)
	OUT  0xA,R30
...
; 0000 0118 // ADC Clock frequency: 1000.000 kHz
; 0000 0119 // ADC Voltage Reference: AREF pin
; 0000 011A // ADC Auto Trigger Source: Timer0 Overflow
; 0000 011B ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 011C ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
; 0000 011D SFIOR=(1<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 011E 
...
; 0000 0125 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0126 
; 0000 0127 // Alphanumeric LCD initialization
; 0000 0128 // Connections are specified in the
; 0000 0129 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 012A // RS - PORTC Bit 0
; 0000 012B // RD - PORTC Bit 1
; 0000 012C // EN - PORTC Bit 2
; 0000 012D // D4 - PORTC Bit 4
; 0000 012E // D5 - PORTC Bit 5
; 0000 012F // D6 - PORTC Bit 6
; 0000 0130 // D7 - PORTC Bit 7
; 0000 0131 // Characters/line: 8
; 0000 0132 lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 0133 
