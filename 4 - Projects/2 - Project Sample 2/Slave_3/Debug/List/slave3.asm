...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	...
	.DEF _critical_situation=R6
	.DEF _critical_situation_msb=R7
	.DEF _address=R8
	.DEF _address_msb=R9
...
;#include <mega32.h>
	...
	#endif
;//This Module Address is 0xDD
;// Declare your global variables here
;int this_module_is_called = 0 ;
;int critical_situation = 0 ;
;int address = 0 ;
...
_0x5:
; 0000 004C 
; 0000 004D    if ( data == 0xDD ){
_0x3:
	CPI  R16,221
	BRNE _0x6
; 0000 004E     critical_situation = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	MOVW R6,R30
; 0000 004F    }
; 0000 0050    else if (data == 0xDF) {
	RJMP _0x7
_0x6:
	CPI  R16,223
	BRNE _0x8
; 0000 0051         critical_situation = 0 ;
	CLR  R6
	CLR  R7
; 0000 0052    }
; 0000 0053 
...
; 0000 0081 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(3)
	OUT  0x14,R30
...
; 0000 00E8       if ( critical_situation == 1 ) {
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R6
	CPC  R31,R7
