...
_0x0:
	.DB  0x74,0x65,0x6D,0x70,0x72,0x65,0x74,0x75
	.DB  0x72,0x65,0x3A,0x20,0x25,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0044    rx_buffer[rx_wr_index++]=data;
	...
	ST   Z,R18
; 0000 0045 #if RX_BUFFER_SIZE == 256
; 0000 0046    // special case for receiver buffer size=256
; 0000 0047    if (++rx_counter == 0) rx_buffer_overflow=1;
; 0000 0048 #else
; 0000 0049    if (rx_wr_index == RX_BUFFER_SIZE) rx_wr_index=0;
	LDI  R30,LOW(8)
	CP   R30,R5
	BRNE _0x4
	CLR  R5
; 0000 004A    if (++rx_counter == RX_BUFFER_SIZE)
_0x4:
	INC  R7
	LDI  R30,LOW(8)
	CP   R30,R7
	BRNE _0x5
; 0000 004B       {
; 0000 004C       rx_counter=0;
	CLR  R7
; 0000 004D       rx_buffer_overflow=1;
	SET
	BLD  R2,0
; 0000 004E       }
; 0000 004F #endif
...
_0x3:
	MOV  R16,R18
	CLR  R17
; 0000 0052    sprintf(str,"tempreture: %d", a);
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 00C2 // USART Transmitter: Off
; 0000 00C3 // USART Mode: Asynchronous
; 0000 00C4 // USART Baud Rate: 9600
; 0000 00C5 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00C6 UCSRB=(1<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(144)
	OUT  0xA,R30
; 0000 00C7 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00C8 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00C9 UBRRL=0x06;
	LDI  R30,LOW(6)
	OUT  0x9,R30
; 0000 00CA 
...
; 0000 00E3 // RS - PORTC Bit 0
; 0000 00E4 // RD - PORTC Bit 1
; 0000 00E5 // EN - PORTC Bit 2
; 0000 00E6 // D4 - PORTC Bit 4
; 0000 00E7 // D5 - PORTC Bit 5
; 0000 00E8 // D6 - PORTC Bit 6
; 0000 00E9 // D7 - PORTC Bit 7
