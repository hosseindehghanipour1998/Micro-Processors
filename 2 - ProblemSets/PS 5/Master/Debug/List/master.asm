...
; 0000 0020     SPDR = data;                       //Load data into the buffer
	ST   -Y,R26
;	data -> Y+0
	LD   R30,Y
	OUT  0xF,R30
; 0000 0021     while(!(SPSR & (1<<SPIF) ));       //Wait until transmission complete
_0x3:
	SBIS 0xE,7
	RJMP _0x3
; 0000 0022     return(SPDR);                      //Return received data
	IN   R30,0xF
	ADIW R28,1
	RET
; 0000 0023 }
...
; 0000 0094 // SPI Type: Master
; 0000 0095 // SPI Clock Rate: 62.500 kHz
; 0000 0096 // SPI Clock Phase: Cycle Start
; 0000 0097 // SPI Clock Polarity: Low
; 0000 0098 // SPI Data Order: MSB First
; 0000 0099 SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (1<<MSTR) | (0<<CPOL) | (0<<CPHA) | (1<<SPR1) | (1<<SPR0);
	LDI  R30,LOW(83)
	OUT  0xD,R30
